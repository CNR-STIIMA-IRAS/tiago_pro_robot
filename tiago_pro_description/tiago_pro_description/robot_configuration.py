...
class RobotConfiguration:
    ...
    def load_configuration(self, robot_name: str) -> Dict[str, RobotSetting]:
        base_path = "/home/user/exchange/tiago_pro_ROS2/src/tiago_pro_robot/tiago_pro_description/tiago_pro_description"
        config_file = f"{base_path}/{robot_name}_config.yaml"
        configurations_raw = yaml.load(
        ...
        for config_name in configurations_raw.keys():
            ...
            setting = RobotSetting(
                config_name, description, values, default_value)
